...
echo " [15] 403 TOOLS"
echo " ==========================================="
echo " [16] MEMBUAT PASSWORD TERMUX"
echo " ==========================================="
echo " [17] MEMBUAT VIRTEX"
echo " ==========================================="
...
#batas
if [ $pil = 16 ] || [ $pil = 16 ];then
git clone https://github.com/MaulanaRyM/Bash-Login
cd Bash-Login
sh login.sh
fi
#batas
if [ $pil = 17 ] || [ $pil = 17 ];then
git clone https://github.com/IntiTutorial/VIRTEX
cd VIRTEX
bash v.sh
fi
#batas
if [ $pil = 18 ] || [ $pil = 18 ];then
